...
$html = '<!doctype html><html><head><title>עורך דין פלילי</title></head><body class="page">'
	...
	. '<main><p>' . $contract['body_marker'] . ' ומטפל בהליך.</p></main></body></html>';
...
jt_assert( 1 === substr_count( $output, 'data-jt-criminal-release="2026-08-02-r1"' ), 'The release body marker is missing.' );
jt_assert( 1 === substr_count( $output, 'data-jt-criminal-hero="2026-08-02-r1"' ), 'The Hero marker is missing.' );
...
$GLOBALS['jt_test_options']['justice_ops_criminal_release_bridge_enabled'] = '0';
