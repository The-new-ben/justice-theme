...
<section class="archive-header">
	<div class="container">
		...
		<h1><?php esc_html_e( 'מדריכים משפטיים לפי הבעיה שלכם', 'justice-theme' ); ?></h1>

		<p>
			<?php esc_html_e( 'בחרו תחום, קראו מה חשוב לדעת עכשיו, הבינו מתי צריך עורך דין והמשיכו לעמודים קשורים בלי ללכת לאיבוד בין נושאים דומים.', 'justice-theme' ); ?>
		</p>
	</div>
</section>
