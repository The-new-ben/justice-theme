<?php
/**
 * Justice Core ג€” REST DB Inspection Tools
 *
 * Routes:
 *   GET /wp-json/justice-core/v1/reports/spam
 *   GET /wp-json/justice-core/v1/reports/duplicates
 *   GET /wp-json/justice-core/v1/reports/users
 *   GET /wp-json/justice-core/v1/reports/cron
 *   GET /wp-json/justice-core/v1/reports/options-suspect
 *
...
add_action( 'rest_api_init', 'uje_register_db_routes' );

function uje_register_db_routes(): void {
	$admin_only = function () {
		return current_user_can( 'manage_options' );
	};

	$routes = array(
		'/reports/spam'            => 'uje_report_spam',
		'/spam-candidates'         => 'uje_report_spam',
		'/reports/duplicates'      => 'uje_report_duplicates',
		'/duplicate-titles'        => 'uje_report_duplicates',
		'/reports/users'           => 'uje_report_users',
		'/reports/cron'            => 'uje_report_cron',
		'/reports/options-suspect' => 'uje_report_options',
		'/reports/plugins'         => 'uje_report_plugins',
		'/reports/log'             => 'uje_report_log',
	);

	foreach ( $routes as $path => $callback ) {
		register_rest_route( 'justice-core/v1', $path, array(
			'methods'             => 'GET',
			'callback'            => $callback,
 ...
 */
function uje_report_spam(): WP_REST_Response {
	global $wpdb;
 ...
 */
function uje_report_duplicates(): WP_REST_Response {
	global $wpdb;
 ...
 */
function uje_report_users(): WP_REST_Response {
	global $wpdb;
...
/**
 * Inspect WP cron jobs ג€” look for suspicious scheduled tasks.
 */
function uje_report_cron(): WP_REST_Response {
 ...
 */
function uje_report_options(): WP_REST_Response {
	global $wpdb;
 ...
 */
function uje_report_plugins(): WP_REST_Response {
 ...
 */
function uje_report_log(): WP_REST_Response {
