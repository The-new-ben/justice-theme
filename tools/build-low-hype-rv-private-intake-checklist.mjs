...
function buildChecklistRows({ gsc, routeOverlap, serp }) {
  ...
  return [
    ...
    },
    {
      ...
      allowed_response: 'Only count money after invoice/reference or private payment proof exists.',
      ...
      forbidden_action: 'Do not mark paid, claim revenue or route as paid lead without proof.',
