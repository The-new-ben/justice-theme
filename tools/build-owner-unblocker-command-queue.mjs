...
const SOURCES = [
  ...
  ['divorceTelAviv', '.reports', 'divorce-tel-aviv-evidence-fill-packet', '2026-05-27'],
...
function buildRows(sources) {
  ...
  return [
    ...
    },
    {
      id: 'UNBLOCK-05',
      rank: 5,
      lane: 'divorce_tel_aviv_local_page',
      owner_reply_needed: 'Verify wp-admin readiness for the 3 visible Tel Aviv family-law cards and provide GSC rows for divorce Tel Aviv query/page clusters.',
      why_it_matters: 'The private evidence route is corrected, but publication cannot proceed without real filtered lawyer coverage and GSC/legal/editor review.',
      exact_next_step: 'Fill the public-draft gate template with profile count/readiness, GSC rows, legal/editor reviewer and owner approval decision.',
      allowed_after_yes: 'Prepare a narrow local fit-check draft that protects the divorce pillar and associated issue pages.',
      hard_no: 'No CMS page, title/H1/meta/body, internal links, directory code, redirects, canonicals/noindex, sitemap or uPress.',
      source_status: statuses.divorceTelAviv,
      source_artifact: '.project-control/divorce-tel-aviv-evidence-fill-packet-2026-05-27.md',
      public_action: 'blocked_pending_owner_gsc_legal',
      crm_or_outreach_action: 'no',
      completion_if_owner_replies: 'Can move from private evidence to owner-review draft preparation.',
    },
    {
      id: 'UNBLOCK-06',
      rank: 6,
