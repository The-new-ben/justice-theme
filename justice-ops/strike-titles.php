...
function justice_strike_map(): array {
	return apply_filters( 'justice_strike_map', array(
		...
		'medical-malpractice-lawsuits-law-account' => array(
			'title' => 'רשלנות רפואית %Y%: בדיקת עילה, התיישנות ופיצויים',
			'desc'  => 'בודק עילה, מחשבון התיישנות, מסמכים, הוכחת רשלנות ודוגמאות פיצוי מפסקי דין מזוהים. כיוון מעשי לפני פנייה לעורך דין. מעודכן %Y%.',
			'h1'    => 'רשלנות רפואית %Y%: בדיקת עילה, התיישנות ופיצויים',
		),
	) );
}
