...
function justice_theme_lawyer_plans(): array {
	return array(
		'free' => array(
			...
			'price'       => 'ללא תשלום',
			'badge'       => 'כניסה למערכת',
			'description' => 'נוכחות ראשונית במדריך עורכי הדין, עם תחומי עיסוק, אזור שירות ופרטי קשר ברורים.',
			'features'    => array(
				'עמוד פרופיל בסיסי',
				'תחומי עיסוק ופרטי קשר',
				'אפשרות שדרוג עתידית למסלול מסחרי',
			),
		),
		'pro' => array(
			'label'       => 'פרופיל מקצועי מורחב',
		...
		'featured' => array(
			...
			'badge'       => 'חשיפה',
			'description' => 'אפשרות להצגה בולטת באזורים רלוונטיים, עם גילוי נאות ושקיפות מלאה.',
			'features'    => array(
