...
<section class="legaltools-archive-hero section">
	<div class="container">
		...
		<p>מסלולים דיגיטליים לאבחון ראשוני, איסוף מידע, יצירת טיוטות וסיכום מסודר לפני שיחה עם עורך דין. המטרה: לעזור לכם להבין את המצב, להכין מסמכים רלוונטיים ולפנות לגורם מתאים בצורה ברורה יותר.</p>
	</div>
</section>
