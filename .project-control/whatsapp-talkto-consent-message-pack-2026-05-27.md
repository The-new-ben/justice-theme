...
| BILLING-01 | lawyer_or_supplier | manual invoice/reference and private payment proof after approved handoff | approved_manual_handoff | READY_FOR_OWNER_LEGAL_REVIEW | בהתאם לתנאים שאושרו מראש עבור הפנייה, נבקש להסדיר תשלום לפי הפרטים שנרשמו. נא לשלוח אישור תשלום/אסמכתא או פרטי חיוב לחשבונית. התשלום יירשם רק לאחר קבלת אסמכתא. | Record qualified_lead_invoice_reference or qualified_lead_payment_evidence_url before marking paid. | After owner release and partner terms are documented. | Do not send before the partner accepted the fee and the handoff was approved. | No private payment evidence means no paid revenue claim. |
