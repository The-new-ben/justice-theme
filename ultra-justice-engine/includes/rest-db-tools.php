 ...
 *
 * Routes:
 *   GET /wp-json/ultra-justice-engine/v1/reports/spam
 *   GET /wp-json/ultra-justice-engine/v1/reports/duplicates
 *   GET /wp-json/ultra-justice-engine/v1/reports/users
 *   GET /wp-json/ultra-justice-engine/v1/reports/cron
 *   GET /wp-json/ultra-justice-engine/v1/reports/options-suspect
 *
...
function uje_register_db_routes(): void {
	...
	foreach ( $routes as $path => $callback ) {
		register_rest_route( 'ultra-justice-engine/v1', $path, array(
			'methods'             => 'GET',
			'callback'            => $callback,
