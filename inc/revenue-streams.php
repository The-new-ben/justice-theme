...
function justice_theme_revenue_streams_backlog(): array {
	return array(
		...
		array(
			...
			'infrastructure' => 'Legal request fulfillment mode started; private owner gate for package, lawyer, engagement, ethics and payment status.',
			'guard'          => 'Needs Israeli Bar ethics review and engagement-letter structure.',
			'next_action'    => 'Use the private fulfillment gate only; get legal/ethics opinion before public product copy or client checkout.',
		),
		array(
			'id'             => '11',
