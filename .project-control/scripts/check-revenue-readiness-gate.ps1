param(
	...
	[string] $ExpectedDeployMarker = "2026-05-28-lawyer-first-value-evidence-guard-v1",
	[string] $ExpectedThemeVersion = "1.1.78",
	[string] $ExpectedComponent = "primary-navigation__mobile-actions",
	[string] $ExpectedWhatsAppSurface = "mobile_menu",
	[string] $OldMarker = "2026-05-28-lawyer-first-value-delivery-action-v1",
	[switch] $Strict
)
