...
add_action( 'wp_head', function () {
	echo '<style id="jt-tools-css">'
		...
		. '.jt-ai-fab{position:fixed;bottom:92px;inset-inline-end:18px;z-index:99989;display:flex;align-items:center;gap:9px;background:linear-gradient(135deg,#14213d,#24406e);color:#e7c765;border:1px solid rgba(231,199,101,.55);border-radius:999px;padding:13px;box-shadow:0 8px 26px rgba(10,18,38,.35);text-decoration:none;transition:transform .15s ease}'
		...
		. '@media (max-width:768px){.jt-ai-fab{bottom:92px;inset-inline-end:12px}}'
