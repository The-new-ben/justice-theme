...
| WT-SRC-07 | qualified_lead_invoice_payment_proof | PASS | inc/lead-crm.php | Billing queue stores invoice references separately from payment evidence and prevents paid status without an evidence URL. | 6/6 | - | Count revenue only after private payment evidence is present; invoice/reference alone can support invoice sent. |
