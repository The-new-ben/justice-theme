# Bituach Leumi First Paid-Lead Readiness - 2026-05-26
...
| BTL-06 | btl_revenue_hint_and_billing_queue_available | PASS | National-insurance leads can be tagged as qualified appeal leads and moved to manual billing after routing. | After one controlled routed lead, save invoice/reference before marking invoice sent or paid. |
