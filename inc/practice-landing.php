	...
	$configs = array(
		...
		'criminal-defense-attorney' => array(
			...
			'quick_path'     => array(
				...
				array( 'label' => 'מחיקת רישום פלילי', 'url' => '/criminal-record-deletion/' ),
			...
			'supporting'     => array(
				...
				array( 'label' => 'מחיקת עבר פלילי', 'url' => '/criminal-record-deletion/' ),
		...
		'real-estate-law'     => array(
			...
			'hide_signals'   => true,
			'quick_path'     => array(
				array( 'label' => 'שכר טרחת עורך דין בקנייה ומכירה', 'url' => '/real-estate-lawyer-cost-2025/' ),
				array( 'label' => 'עורך דין לקנייה או מכירת דירה', 'url' => '/lawyer-for-buying-or-selling-a-house/' ),
				array( 'label' => 'קניית דירה מקבלן', 'url' => '/buying-apartment-from-contractor/' ),
				array( 'label' => 'רישום זכויות בטאבו', 'url' => '/registration-of-real-estate-israel/' ),
			),
			'practice_scope' => array(
				array( 'label' => 'עורך דין מקרקעין', 'url' => '/real-estate-lawyer-guide/' ),
				array( 'label' => 'שכר טרחה בקנייה ומכירה', 'url' => '/real-estate-lawyer-cost-2025/' ),
				array( 'label' => 'קנייה ומכירת דירה', 'url' => '/lawyer-for-buying-or-selling-a-house/' ),
				array( 'label' => 'קניית דירה מקבלן', 'url' => '/buying-apartment-from-contractor/' ),
