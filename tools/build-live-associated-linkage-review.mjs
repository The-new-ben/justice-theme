...
function buildCandidateRows(rows) {
  ...
  const candidatePairs = [
    ...
    },
    {
      ...
      target: '/real-estate-lawyer-guide/',
      suggested_anchor_he: '׳׳“׳¨׳™׳ ׳׳¢׳•׳¨׳ ׳“׳™׳ ׳׳§׳¨׳§׳¢׳™׳ ׳‘׳¢׳¡׳§׳׳•׳× ׳•׳—׳•׳–׳™׳',
      placement: 'Rental agreement next-step or related reading section',
      user_intent: 'Rental-agreement reader who needs broader real-estate legal context.',
      cannibalization_risk: 'MEDIUM',
      approval_required: 'Owner + SEO review; keep rental agreement as the contract-specific page.',
      owner_action: 'Approve only if the link supports broader real-estate context without replacing the rental-contract intent.',
    },
    {
      id: 'LINK-012',
      source: '/rental-agreement/',
      target: '/eviction-notice-israel/',
      suggested_anchor_he: '׳₪׳™׳ ׳•׳™ ׳©׳•׳›׳¨ ׳•׳”׳₪׳¨׳× ׳”׳¡׳›׳ ׳©׳›׳™׳¨׳•׳×',
      placement: 'Rental agreement risks or breach section',
      user_intent: 'Reader checking what happens if a rental agreement is breached.',
      cannibalization_risk: 'MEDIUM',
      approval_required: 'Owner + SEO review; do not blend contract review with eviction dispute intent.',
      owner_action: 'Approve only as an adjacent-risk link, not as a packaged-service CTA.',
    },
    {
      id: 'LINK-013',
      source: '/eviction-notice-israel/',
      target: '/rental-agreement/',
      suggested_anchor_he: '׳‘׳“׳™׳§׳× ׳”׳¡׳›׳ ׳”׳©׳›׳™׳¨׳•׳× ׳©׳¢׳׳™׳• ׳”׳ž׳—׳׳•׳§׳×',
      placement: 'Eviction/dispute evidence section',
      user_intent: 'Dispute reader needs to inspect the underlying lease terms.',
      cannibalization_risk: 'MEDIUM',
      approval_required: 'Owner + SEO review; preserve eviction/dispute vs contract-document split.',
      owner_action: 'Approve if the page explains that contract terms are evidence, not a duplicate eviction guide.',
    },
    {
      id: 'LINK-014',
      source: '/labor-lawyer/',
      target: '/lawyers/',
      suggested_anchor_he: '׳—׳™׳₪׳•׳© ׳¢׳•׳¨׳›׳™ ׳“׳™׳ ׳“׳™׳ ׳™ ׳¢׳‘׳•׳“׳”',
      placement: 'Employment-law next-step CTA',
      user_intent: 'Employment-law visitor ready to compare lawyer profiles.',
      cannibalization_risk: 'LOW',
      approval_required: 'Owner/public UX review; no SEO metadata change.',
      owner_action: 'Approve if the directory can support employment-law profile discovery without making the page feel sales-heavy.',
    },
    {
      id: 'LINK-015',
      source: '/consumer-rights-israel/',
      target: '/lawyers/',
      suggested_anchor_he: '׳—׳™׳₪׳•׳© ׳¢׳•׳¨׳›׳™ ׳“׳™׳ ׳¦׳¨׳›׳ ׳•׳×',
      placement: 'Consumer-rights next-step CTA',
      user_intent: 'Consumer-rights visitor ready to compare lawyer profiles.',
      cannibalization_risk: 'LOW',
      approval_required: 'Owner/public UX review; no SEO metadata change.',
      owner_action: 'Approve if the directory can support consumer-law profile discovery without replacing the guide content.',
    },
    {
      id: 'LINK-016',
      source: '/eviction-notice-israel/',
      target: '/lawyers/',
      suggested_anchor_he: '׳—׳™׳₪׳•׳© ׳¢׳•׳¨׳›׳™ ׳“׳™׳ ׳׳₪׳™׳ ׳•׳™ ׳©׳•׳›׳¨',
      placement: 'Eviction/dispute next-step CTA',
      user_intent: 'Rental-dispute visitor ready to compare lawyer profiles.',
      cannibalization_risk: 'LOW',
      approval_required: 'Owner/public UX review; no SEO metadata change.',
      owner_action: 'Approve if the directory path preserves the eviction/dispute context and does not add another repeated homepage-style CTA.',
    },
    {
      id: 'LINK-017',
      source: '/labor-lawyer/',
      target: 'DEMAND_LETTER_EMPLOYMENT_CONTEXT_PLACEHOLDER',
      suggested_anchor_he: '׳׳›׳×׳‘ ׳“׳¨׳™׳©׳” ׳‘׳“׳™׳ ׳™ ׳¢׳‘׳•׳“׳”',
      placement: 'Only after owner chooses employment as the first demand-letter context',
      user_intent: 'Employee/employer needs a lawyer-reviewed written demand in an employment dispute.',
      cannibalization_risk: 'HIGH',
      approval_required: 'Owner + SEO + legal review; generic demand-letter page remains blocked.',
      owner_action: 'Do not publish or link this until the demand-letter employment copy packet is approved.',
    },
    {
      id: 'LINK-018',
      source: '/consumer-rights-israel/',
      target: 'DEMAND_LETTER_CONSUMER_CONTEXT_PLACEHOLDER',
      suggested_anchor_he: '׳׳›׳×׳‘ ׳“׳¨׳™׳©׳” ׳׳¢׳¡׳§ ׳׳• ׳¡׳₪׳§',
      placement: 'Only after owner chooses consumer disputes as the first demand-letter context',
      user_intent: 'Consumer wants a lawyer-reviewed demand before small claims or escalation.',
      cannibalization_risk: 'HIGH',
      approval_required: 'Owner + SEO + legal review; generic demand-letter page remains blocked.',
      owner_action: 'Do not publish or link this until the consumer-demand copy packet is approved.',
    },
    {
      id: 'LINK-019',
      source: '/eviction-notice-israel/',
      target: 'DEMAND_LETTER_RENTAL_CONTEXT_PLACEHOLDER',
      suggested_anchor_he: '׳׳›׳×׳‘ ׳“׳¨׳™׳©׳” ׳‘׳¡׳›׳¡׳•׳ ׳©׳›׳™׳¨׳•׳×',
      placement: 'Only after owner chooses rental dispute as the first demand-letter context',
      user_intent: 'Tenant or landlord needs a lawyer-reviewed written demand in a rental dispute.',
      cannibalization_risk: 'HIGH',
      approval_required: 'Owner + SEO + legal review; keep separate from rental agreement review.',
      owner_action: 'Do not publish or link this until the rental-dispute demand copy packet is approved.',
    },
  ];
...
function markdownReport(rows, sourceReport, reportDate) {
  ...
  const lines = [
    ...
    '- Rental agreement and eviction cross-links are medium-risk because contract-review and dispute/eviction intent must stay distinct.',
    '- Demand-letter context rows are high-risk placeholders; do not create a generic demand-letter route or CTA without owner/SEO/legal approval.',
