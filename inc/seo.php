...
function justice_theme_money_query_seo_map(): array {
	$map = array(
		...
		'criminal-defense-attorney' => array(
			...
			'seo_title'   => 'עורך דין פלילי ' . wp_date( 'Y' ) . ': מה עושים בחקירה, מעצר ושימוע | Jus-Tice',
			'description' => 'זומנתם לחקירה, נעצרתם או קיבלתם מכתב שימוע? מפת פעולה לפי שלב: זכויות, מועדים קריטיים, רישום פלילי ושכר טרחה. מעודכן ' . wp_date( 'Y' ) . '.',
		...
		// BATCH 4, traffic-emergency sweep (2026-07-03, GSC 2026-06-09): the
...
function justice_theme_year_fresh_seo_map(): array {
	...
	return array(
		...
		'online-rent-agreement' => array(
			'title'       => 'חוזה שכירות אונליין להורדה חינם: נוסח מעודכן ' . $year,
			'seo_title'   => 'חוזה שכירות אונליין להורדה חינם: נוסח מעודכן ' . $year . ' | Jus-Tice',
			'description' => 'חוזה שכירות אונליין בנוסח סטנדרטי מעודכן ' . $year . ': מילוי והורדה חינם בלי הרשמה, כולל ערבויות, ביטחונות והסעיפים שחייבים לבדוק לפני חתימה.',
		),
		// GSC 2026-07-12: page one for the head query with 0.13% CTR. The head
		// term now leads, the download promise and the year ride the title.
		'free-divorce-agreement-template' => array(
			'title'       => 'הסכם גירושין ' . $year . ': דוגמה מלאה להורדה ומה חייב להופיע',
			'seo_title'   => 'הסכם גירושין: דוגמה מלאה להורדה חינם, נוסח ' . $year . ' | Jus-Tice',
			'description' => 'דוגמה מלאה של הסכם גירושין להורדה, סעיף אחרי סעיף: רכוש, משמורת, מזונות ותהליך האישור בבית המשפט או בבית הדין הרבני. נוסח מעודכן ' . $year . '.',
		),
		'apply-for-police-criminal-information-certificates' => array(
			'title'       => 'תעודת יושר (מידע פלילי): הגשת בקשה אונליין, זכאות וזמנים',
			'seo_title'   => 'תעודת יושר ' . $year . ': בקשה לתעודת מידע פלילי אונליין | Jus-Tice',
			'description' => 'בקשה לתעודת מידע פלילי (תעודת יושר) אונליין: מי זכאי, איך מגישים למשטרה צעד אחר צעד, כמה זמן לוקח ומה עושים כשיש רישום. מעודכן ' . $year . '.',
		),
