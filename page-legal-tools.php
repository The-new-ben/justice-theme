...
<div class="justice-ai-app" id="justice-ai-app" dir="rtl">
	...
	<section class="hero">
		...
		<figure class="hero-media">
			<img src="<?php echo esc_url( JUSTICE_THEME_URI . '/assets/images/guide-hero.png' ); ?>" alt="<?php esc_attr_e( 'הכנת מסמך משפטי במחשב לפני בדיקת עורך דין', 'justice-theme' ); ?>" loading="eager" width="430" height="330">
