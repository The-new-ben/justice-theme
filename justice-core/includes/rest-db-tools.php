...
function justice_core_register_db_routes(): void {
	$admin_only = function () {
		return current_user_can( 'manage_options' );
	};

	$routes = array(
		'/reports/spam'            => 'justice_core_report_spam',
		'/reports/duplicates'      => 'justice_core_report_duplicates',
		'/reports/users'           => 'justice_core_report_users',
		'/reports/cron'            => 'justice_core_report_cron',
		'/reports/options-suspect' => 'justice_core_report_options',
		'/reports/plugins'         => 'justice_core_report_plugins',
		'/reports/log'             => 'justice_core_report_log',
	);
 ...
 */
function justice_core_report_spam(): WP_REST_Response {
	global $wpdb;
 ...
 */
function justice_core_report_duplicates(): WP_REST_Response {
	global $wpdb;
 ...
 */
function justice_core_report_users(): WP_REST_Response {
	global $wpdb;
 ...
 */
function justice_core_report_cron(): WP_REST_Response {
 ...
 */
function justice_core_report_options(): WP_REST_Response {
	global $wpdb;
 ...
 */
function justice_core_report_plugins(): WP_REST_Response {
 ...
 */
function justice_core_report_log(): WP_REST_Response {
