...
add_action( 'wp_enqueue_scripts', function (): void {
	...
	wp_register_script( 'justice-ops-hadmaia-review', '', array(), JUSTICE_OPS_VERSION, true );
	wp_enqueue_script( 'justice-ops-hadmaia-review' );
	wp_add_inline_script(
		'justice-ops-hadmaia-review',
		'window.JusticeHadmaiaReview=' . wp_json_encode( $config, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES ) . ';' .
