...
// Resolve pillar URL: prefer practice-areas taxonomy term link if it exists,
// else fall back to the lawyer directory filtered by area slug — that endpoint
// is always live (handled by archive-justice_lawyer.php). This avoids 404s.
$lawyers_archive = get_post_type_archive_link( 'justice_lawyer' ) ?: home_url( '/lawyers/' );

$justice_pillar_link = function ( $area_slug ) use ( $lawyers_archive ) {
	$term = get_term_by( 'slug', $area_slug, 'practice-areas' );
	...
	return add_query_arg( 'area', $area_slug, $lawyers_archive );
};
...
$pillars = array(
	array(
		...
		'link'  => $justice_pillar_link( 'family-law' ),
	),
	array(
		...
		'link'  => $justice_pillar_link( 'criminal-law' ),
	),
	array(
		...
		'link'  => $justice_pillar_link( 'traffic-law' ),
	),
	array(
		...
		'link'  => $justice_pillar_link( 'real-estate' ),
	),
	array(
		...
		'link'  => $justice_pillar_link( 'labor-law' ),
	),
	array(
		...
		'link'  => $justice_pillar_link( 'inheritance' ),
	),
);
?>
