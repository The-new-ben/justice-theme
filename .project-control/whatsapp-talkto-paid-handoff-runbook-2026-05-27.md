...
| WT-SRC-07 | qualified_lead_invoice_payment_proof | PASS | inc/lead-crm.php | Billing queue stores invoice/payment proof and prevents bare paid status from standing without proof. | 5/5 | - | Count revenue only after invoice/reference or private payment evidence is present. |
