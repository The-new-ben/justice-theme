 ...
 */
function justice_core_register_lawyer_cpt() {
	$labels = array(
		'name'               => 'עורכי דין',
...
add_action( 'init', 'justice_core_register_lawyer_cpt' );

/**
 * Register all lawyer meta fields.
 */
function justice_core_register_lawyer_meta() {
	$fields = array(
		// Identity
...
add_action( 'init', 'justice_core_register_lawyer_meta' );

/**
 * Admin columns for lawyer listing.
 */
function justice_core_lawyer_admin_columns( $columns ) {
	$new = array();
...
add_filter( 'manage_justice_lawyer_posts_columns', 'justice_core_lawyer_admin_columns' );

/**
 * Populate admin columns.
 */
function justice_core_lawyer_column_content( $column, $post_id ) {
	switch ( $column ) {
		case 'lawyer_plan':
...
add_action( 'manage_justice_lawyer_posts_custom_column', 'justice_core_lawyer_column_content', 10, 2 );

/**
 * Sortable columns.
 */
function justice_core_lawyer_sortable_columns( $columns ) {
	$columns['lawyer_views'] = 'profile_views';
	$columns['lawyer_leads'] = 'leads_received';
	return $columns;
}
add_filter( 'manage_edit-justice_lawyer_sortable_columns', 'justice_core_lawyer_sortable_columns' );

/**
 * Meta box for lawyer details.
 */
function justice_core_lawyer_meta_boxes() {
	add_meta_box( 'justice_lawyer_identity', 'זהות עורך הדין', 'justice_core_lawyer_identity_box', 'justice_lawyer', 'normal', 'high' );
	add_meta_box( 'justice_lawyer_contact', 'פרטי התקשרות', 'justice_core_lawyer_contact_box', 'justice_lawyer', 'normal', 'default' );
	add_meta_box( 'justice_lawyer_commercial', 'מסחרי ומנהלי', 'justice_core_lawyer_commercial_box', 'justice_lawyer', 'side', 'default' );
}
add_action( 'add_meta_boxes', 'justice_core_lawyer_meta_boxes' );

/**
 * Identity meta box.
 */
function justice_core_lawyer_identity_box( $post ) {
	...
	justice_core_render_meta_fields( $post, $fields );
}

/**
 * Contact meta box.
 */
function justice_core_lawyer_contact_box( $post ) {
	$fields = array(
 ...
 * Commercial meta box.
 */
function justice_core_lawyer_commercial_box( $post ) {
	$fields = array(
 ...
 */
function justice_core_render_meta_fields( $post, $fields ) {
 ...
 * Save lawyer meta.
 */
function justice_core_save_lawyer_meta( $post_id ) {
...
add_action( 'save_post_justice_lawyer', 'justice_core_save_lawyer_meta' );
