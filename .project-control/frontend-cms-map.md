...
| Favicon/site icon | `inc/seo.php`, `assets/images/favicon.svg`, `assets/images/site-icon-512.png` | WordPress Site Icon, repo fallback SVG/PNG/ICO | YES | wp-admin selected Site Icon not verified | Prefer WP Site Icon; fallback assets are ready and stable |
...
| Lead form | `ask-lawyer.php`, `template-parts/forms/lead-form.php`, `single-justice_lawyer.php`, `inc/lead-spam-guard.php`, plugin lead handlers | `admin-post.php`, `justice_lead` CPT/meta, `assigned_lawyer_id`, `source_keyword`, UTM fields | PARTIAL | Live routing/attribution not verified | Submit test lead after deploy and confirm assigned lawyer/meta/source keyword/UTM in CRM |
