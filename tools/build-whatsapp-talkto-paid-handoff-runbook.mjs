...
const rows = [
  ...
  },
  {
    ...
    blocked_action: 'Do not mark paid, claim paid revenue, or activate paid status without private payment evidence.',
  ...
  },
  {
    ...
    allowed_action: 'Attach the client to a partner through the CRM, record billing queue state, then collect invoice/reference for invoice_sent and private payment evidence for paid.',
