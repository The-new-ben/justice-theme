...
const gates = [
  ...
  },
  {
    ...
    markers: [
      ...
      "array( 'upgrade', 'downgrade', 'cancel', 'refund', 'invoice'",
      'data-service-request-preset="<?php echo esc_attr( $preset_key ); ?>"',
      'justice_lawyer_lead_stage_update',
    ],
    nextAction: 'Walk through the lawyer dashboard after a claimed profile exists: payment link, upgrade, downgrade, cancel, refund, invoice and lead-stage update.',
    ownerNotice: 'Requires a real logged-in lawyer user linked to a claimed lawyer profile.',
  },
  {
    id: 'LSE-06',
    ...
    ownerNotice: 'This proves handlers exist; it does not prove a live lawyer session or lead assignment exists.',
  },
  {
    id: 'LSE-07',
