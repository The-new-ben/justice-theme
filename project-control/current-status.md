...
- Third supporting family-law draft now exists at `content-drafts/child-support-supporting-he.md` and was expanded to about 2,120 words with no-fake-calculator policy, intake model, medor, exceptional expenses, time-sharing, variable income, agreement clauses, temporary support and CRM routing. It is still NOT legal-reviewed and not ready to publish.
