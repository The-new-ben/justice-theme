...
function justice_theme_payment_compliance_render_body( string $slug ): void {
	...
	<section class="jt-compliance-card">
		...
		<p>המסלולים בתשלום כוללים שירותים דיגיטליים כגון פרופיל מקצועי מורחב, חשיפה באתר, דוחות ערך, כלי מוניטין ופניות בהתאם למסלול שנבחר. כל פרסום ממומן יסומן בהתאם לכללי לשכת עורכי הדין.</p>
