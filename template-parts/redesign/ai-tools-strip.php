...
$justice_ai_tools = array(
	...
	array(
		...
		'badge'       => 'free',
		'title'       => __( 'מכתב התראה', 'justice-theme' ),
		'desc'        => __( 'פרטי הצדדים, עובדות ודרישה כספית במסמך מסודר.', 'justice-theme' ),
		'url'         => add_query_arg( 'tool', 'demand-letter', $justice_tools_hub ),
		'cross_url'   => home_url( '/lawyers/' ),
		'cross_label' => __( 'חיפוש עורך דין מתאים', 'justice-theme' ),
	),
	array(
		'type'        => __( 'טיוטה חינם', 'justice-theme' ),
		'badge'       => 'free',
