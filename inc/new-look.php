...
// The one-minute Hadmaya film, as a quiet card after the article body (owner order 2026-09-23).
if ( is_file( __DIR__ . '/hadmaya-film-card.php' ) ) {
	require_once __DIR__ . '/hadmaya-film-card.php';
}
