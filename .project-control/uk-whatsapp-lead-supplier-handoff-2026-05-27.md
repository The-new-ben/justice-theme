...
| UK-SRC-06 | billing_proof_guard | PASS | inc/lead-crm.php | Billing state cannot honestly become paid without invoice/reference or private payment proof. | 5/5 | - | Use manual invoice/payment evidence until Grow/Morning provider status is fully verified. |
...
| UK-08 | money | Justice CRM -> Qualified lead billing queue | Move to ready_to_bill/invoice_sent/paid only with invoice reference or private payment evidence. | MANUAL_INVOICE_PATH | Collect and store invoice/payment proof before claiming revenue. | Partner accepted fee and owner release happened for this lead. | Do not mark paid or claim revenue without proof. |
