...
add_action( 'wp_head', function () {
	...
	echo '<style id="jtcm-css">'
		...
		. '.jtcm-pop__badge,.jtcm-pop__sponsored{display:inline-block;background:#f2f5fb;color:#5a6579;border:1px solid #dbe3f0;border-radius:999px;padding:2px 9px;font-size:10.5px;font-weight:700;margin-top:4px;align-self:flex-start}'
		. '.jtcm-pop__sponsored{background:#fff8dc;color:#765b0e;border-color:#e7c765}'
