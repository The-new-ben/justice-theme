 ...
 *
 * Routes:
 *   GET /wp-json/ultra-justice-engine/v1/content/lawyers
 *   GET /wp-json/ultra-justice-engine/v1/content/posts
 *   GET /wp-json/ultra-justice-engine/v1/content/leads
 *   POST /wp-json/ultra-justice-engine/v1/content/update-meta
 *   POST /wp-json/ultra-justice-engine/v1/content/trash-post
 *
...
function uje_register_content_routes(): void {
	...
	// Read routes
	register_rest_route( 'ultra-justice-engine/v1', '/content/lawyers', array(
		'methods'             => 'GET',
	...
	register_rest_route( 'ultra-justice-engine/v1', '/content/posts', array(
		'methods'             => 'GET',
	...
	register_rest_route( 'ultra-justice-engine/v1', '/content/leads', array(
		'methods'             => 'GET',
	...
	// Write routes
	register_rest_route( 'ultra-justice-engine/v1', '/content/update-meta', array(
		'methods'             => 'POST',
	...
	register_rest_route( 'ultra-justice-engine/v1', '/content/trash-post', array(
		'methods'             => 'POST',
